...
function FeatureCard({ icon, title, description }) {
  return (
    <article className="flex overflow-hidden flex-col flex-1 shrink self-stretch px-9 py-12 my-auto basis-0 min-w-[240px] max-md:px-5 bg-gradient-to-r from-[#F4F8FF] to-[#E4EFFF] hover:bg-[#D6FFF3] transition-colors duration-300" style={{ height: "300px" }}>
